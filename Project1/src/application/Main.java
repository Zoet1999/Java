...
public class Main extends Application {
	...
	TextField CarText1= new TextField ();		//4辆车的速度输入框，用ENTER可以及时改变速度
	TextField CarText2= new TextField ();
	TextField CarText3= new TextField ();
	TextField CarText4= new TextField ();
	Button RaceStart=new Button("Start Race");	//同时改变速度的按钮，事件为同时改变四辆车的
	Car car1= new Car();						//4辆车类的初始化
	Car car2= new Car();
	Car car3= new Car();
	Car car4= new Car();
	
	//---------存数据的变量--------------------
	double s1=0;//存储从4辆车的速度输入框TextField中得到的速度的值
	double s2=0;
	double s3=0;
	double s4=0;
	@Override
